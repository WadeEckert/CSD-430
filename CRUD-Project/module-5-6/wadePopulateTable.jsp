            ...
            <div class="deliverable-grid">
                ...
                <a class="deliverable-card" href="wadeCreateTable.jsp">
                    ...
                    <span class="deliverable-description">
                        Verify the project database and create the states table if it is currently missing.
                    </span>
                </a>
                ...
                <a class="deliverable-card" href="../index.jsp">
                    ...
                    <span class="deliverable-description">
                        Return to the main CRUD project page and review the available database utilities and deliverables.
                    </span>
                </a>
